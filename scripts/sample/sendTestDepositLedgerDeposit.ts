...
import { createDepositClient, deriveAccountsFromMnemonic } from "@gammaswap/v2-exchange-sdk";
...
async function main() {
  ...
  const client = createDepositClient({
    ...
    wallet,
    chainId: CHAIN_ID,
    ...(DEPOSIT_LEDGER_CONTRACT === undefined ? {} : { depositLedger: DEPOSIT_LEDGER_CONTRACT }),
  });
